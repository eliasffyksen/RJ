...
impl parser::ASTParser for ast::statement::Statement {
        ...
        Self: ast::PoolType,
    {
        ...
        let statement = match pair.as_rule() {
            parser::Rule::var_decl => ast::statement::Statement::VariableDeclaration(ast::Variable::parse(pool, pair)),
            parser::Rule::func_ret => ast::statement::Statement::Return(ast::statement::Return::parse(pool, pair)),
